...
![Beispiel zu einem guten und einem schlechten Kontrastverhältnis von Text auf Hintergrund](/assets/images/blog/a11y-basics/a11y_beispiel_1.png)
...
<a href="https://bitvtest.de/pruefschritt/wcag-22-web/wcag-22-web-1-4-3-kontraste-von-texten-ausreichend" target="_blank" rel="noopener">Mehr zu Kriterium 1.4.3<a/>
...
<a href="https://bitvtest.de/pruefschritt/wcag-22-web/wcag-22-web-1-4-11-kontraste-von-grafiken-und-grafischen-bedienelementen-ausreichend" target="_blank" rel="noopener">Mehr zu Kriterium 1.4.11<a/>
...
Hier ist es wichtig zu gewährleisten, dass der Text auch dann noch lesbar ist, wenn er bis zu 200 % vergrößert wird. Und zwar ohne horizontales Scrollen. So stehts in <a href="https://bitvtest.de/pruefschritt/wcag-22-web/wcag-22-web-1-4-4-text-auf-200-vergroesserbar" target="_blank" rel="noopener">Kriterium 1.4.4<a/>


Dazu gehört laut <a href="https://bitvtest.de/pruefschritt/wcag-22-web/wcag-22-web-1-4-12-textabstaende-anpassbar" target="_blank" rel="noopener">Kriterium 1.4.12<a/> auch, dass genügend Zeilen- und Absatzabstände vorhanden sind oder eingestellt werden können. Denn wer zum Beispiel Dyslexie (Leseschwierigkeit) hat oder mit einer Sehschwäche liest, braucht mehr „Luft“ zwischen den Zeilen. Empfohlen wird ein mindestens 1,5-facher Zeilenabstand.
...
![Gegenüberstellung eines Textes in Großbuchstaben, und eines Textes mit Kleinbuchstaben](/assets/images/blog/a11y-basics/a11y_beispiel_3.png)